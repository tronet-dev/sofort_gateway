...
<div id="tro-sofort-main-page-wrap">
    ...
    <p>
        ...
        [{assign var='sTroCheckNewVersion' value=$sTroHomeUrl|cat:'&cl=\Tronet\Trosofortueberweisung\Application\Controller\Admin\TrosofortueberweisungMainController&fnc=troCheckForUpdates'}]
        ...
        [{assign var='sTroCheckForChanges' value=$sTroHomeUrl|cat:'&cl=\Tronet\Trosofortueberweisung\Application\Controller\Admin\TrosofortueberweisungMainController&fnc=troCheckForChanges'}]
    ...
    [{if $blTroCheckedForUpdates}]
        ...
        <div class="messagebox">
            ...
            [{foreach from=$aMessage key="sTroMessageKey" item="sTroMessageItem"}]
