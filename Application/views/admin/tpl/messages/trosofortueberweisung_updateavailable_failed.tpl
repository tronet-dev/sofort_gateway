...
<img id="tro-sofort-notify-image" src="[{$oViewConf->getBaseDir()}]modules/tronet/trosofortueberweisung/tronet.gif"/> [{oxmultilang ident="TRO_NEW_VERSION_AVAILABLE_FAILED"}]
